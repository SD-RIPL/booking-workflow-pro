  ...
  public: {
    Tables: {
      ...
      booking_stage_history: {
        Row: {
          booking_id: string
          from_stage: Database["public"]["Enums"]["booking_stage"] | null
          id: string
          performed_at: string
          performed_by: string | null
          remarks: string | null
          to_stage: Database["public"]["Enums"]["booking_stage"]
        }
        Insert: {
          booking_id: string
          from_stage?: Database["public"]["Enums"]["booking_stage"] | null
    ...
    Functions: {
      advance_booking_stage: {
        Args: {
          p_booking_id: string
          p_remarks?: string
          p_target_stage: Database["public"]["Enums"]["booking_stage"]
        }
        Returns: {
          aadhaar_no: string | null
          activation_date: string | null
      ...
      verify_deposit_and_promote: {
        Args: { p_deposit_id: string; p_remarks?: string }
        Returns: {
          activation_date: string | null
          address: string | null
          address_line: string | null
